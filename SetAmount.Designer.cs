namespace RP_Calculator
{
	partial class form_SetAmount
	{
		...
		private void InitializeComponent()
		{
			...
			this.textBox_setRP3 = new System.Windows.Forms.TextBox();
			this.textBox_setRP2 = new System.Windows.Forms.TextBox();
			this.textBox_setRP1 = new System.Windows.Forms.TextBox();
			this.textBox_setRP0 = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.button_CancelSetCharge = new System.Windows.Forms.Button();
			this.button_ApplySetCharge = new System.Windows.Forms.Button();
			...
			// textBox_setKRW0
			// 
			this.textBox_setKRW0.Location = new System.Drawing.Point(6, 22);
			...
			// groupBox1
			// 
			this.groupBox1.Controls.Add(this.textBox_setKRW5);
			this.groupBox1.Controls.Add(this.textBox_setKRW4);
			this.groupBox1.Controls.Add(this.textBox_setKRW3);
			this.groupBox1.Controls.Add(this.textBox_setKRW2);
			this.groupBox1.Controls.Add(this.textBox_setKRW1);
			this.groupBox1.Controls.Add(this.textBox_setKRW0);
			...
			// textBox_setKRW4
			// 
			this.textBox_setKRW4.Location = new System.Drawing.Point(6, 138);
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this.textBox_setRP5);
			this.groupBox2.Controls.Add(this.textBox_setRP4);
			this.groupBox2.Controls.Add(this.textBox_setRP3);
			this.groupBox2.Controls.Add(this.textBox_setRP2);
			this.groupBox2.Controls.Add(this.textBox_setRP1);
			this.groupBox2.Controls.Add(this.textBox_setRP0);
			this.groupBox2.Location = new System.Drawing.Point(157, 12);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(115, 201);
			this.groupBox2.TabIndex = 2;
			this.groupBox2.TabStop = false;
			this.groupBox2.Text = "충전 RP";
			// 
			// textBox_setRP5
			// 
			this.textBox_setRP5.Location = new System.Drawing.Point(6, 167);
			...
			// textBox_setRP4
			// 
			this.textBox_setRP4.Location = new System.Drawing.Point(6, 138);
			...
			// textBox_setRP3
			// 
			this.textBox_setRP3.Location = new System.Drawing.Point(6, 109);
			...
			// textBox_setRP2
			// 
			this.textBox_setRP2.Location = new System.Drawing.Point(6, 80);
			...
			// textBox_setRP1
			// 
			this.textBox_setRP1.Location = new System.Drawing.Point(6, 51);
			...
			// textBox_setRP0
			// 
			this.textBox_setRP0.Location = new System.Drawing.Point(6, 22);
			...
			this.label1.Text = "→";
			// 
			// button_CancelSetCharge
			// 
			this.button_CancelSetCharge.BackColor = System.Drawing.Color.LightSalmon;
			this.button_CancelSetCharge.ForeColor = System.Drawing.SystemColors.ControlText;
			this.button_CancelSetCharge.Location = new System.Drawing.Point(12, 219);
			this.button_CancelSetCharge.Name = "button_CancelSetCharge";
			this.button_CancelSetCharge.Size = new System.Drawing.Size(115, 23);
			...
			// 
			this.button_ApplySetCharge.Location = new System.Drawing.Point(157, 219);
			this.button_ApplySetCharge.Name = "button_ApplySetCharge";
			this.button_ApplySetCharge.Size = new System.Drawing.Size(115, 23);
			...
			this.Controls.Add(this.button_ApplySetCharge);
			this.Controls.Add(this.button_CancelSetCharge);
			this.Controls.Add(this.label1);
			this.Controls.Add(this.groupBox2);
			this.Controls.Add(this.groupBox1);
			this.MaximizeBox = false;
			this.MinimizeBox = false;
			this.Name = "form_SetAmount";
			this.ShowIcon = false;
			this.Text = "충전 금액 설정";
		...
		private TextBox textBox_setKRW0;
		private GroupBox groupBox1;
		private TextBox textBox_setKRW5;
		private TextBox textBox_setKRW4;
		private TextBox textBox_setKRW3;
		private TextBox textBox_setKRW2;
		private TextBox textBox_setKRW1;
		private GroupBox groupBox2;
		private TextBox textBox_setRP5;
		private TextBox textBox_setRP4;
		private TextBox textBox_setRP3;
		private TextBox textBox_setRP2;
		private TextBox textBox_setRP1;
		private TextBox textBox_setRP0;
		private Label label1;
		private Button button_CancelSetCharge;
		private Button button_ApplySetCharge;
	}
}